 ...
 * @relates AranyaClient.
 */
AranyaError aranya_role_assigners(const struct AranyaClient *client,
                                  const struct AranyaTeamId *team,
                                  const struct AranyaRoleId *role,
                                  struct AranyaRole *roles_out,
                                  size_t *roles_len);
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_role_assigners_ext(const struct AranyaClient *client,
                                      const struct AranyaTeamId *team,
                                      const struct AranyaRoleId *role,
                                      struct AranyaRole *roles_out,
                                      size_t *roles_len,
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_role_revokers(const struct AranyaClient *client,
                                 const struct AranyaTeamId *team,
                                 const struct AranyaRoleId *role,
                                 struct AranyaRole *roles_out,
                                 size_t *roles_len);
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_role_revokers_ext(const struct AranyaClient *client,
                                     const struct AranyaTeamId *team,
                                     const struct AranyaRoleId *role,
                                     struct AranyaRole *roles_out,
                                     size_t *roles_len,
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_role_permission_managers(const struct AranyaClient *client,
                                            const struct AranyaTeamId *team,
                                            const struct AranyaRoleId *role,
                                            struct AranyaRole *roles_out,
                                            size_t *roles_len);
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_role_permission_managers_ext(const struct AranyaClient *client,
                                                const struct AranyaTeamId *team,
                                                const struct AranyaRoleId *role,
                                                struct AranyaRole *roles_out,
                                                size_t *roles_len,
