...
/**
 * The size in bytes of a `DeviceId` converted to a human-readable base64
 * string.
 */
 ...
 *
 * @param err the error to get a message for [`AranyaExtError`](@ref
 * AranyaExtError).
 ...
 */
AranyaError
aranya_afc_config_builder_set_shm_path(struct AranyaAfcConfigBuilder *cfg,
                                       const char *shm_path);
#endif
 ...
 */
AranyaError
aranya_afc_config_builder_set_shm_path_ext(struct AranyaAfcConfigBuilder *cfg,
                                           const char *shm_path,
                                           struct AranyaExtError *__ext_err);
#endif
 ...
 */
AranyaError
aranya_afc_config_builder_set_max_channels(struct AranyaAfcConfigBuilder *cfg,
                                           size_t max_channels);
#endif
 ...
 * @param max_channels the maximum number of channels allowed
 */
AranyaError aranya_afc_config_builder_set_max_channels_ext(
    struct AranyaAfcConfigBuilder *cfg, size_t max_channels,
    struct AranyaExtError *__ext_err);
#endif
 ...
 */
AranyaError
aranya_afc_config_builder_set_address(struct AranyaAfcConfigBuilder *cfg,
                                      const char *address);
#endif
 ...
 */
AranyaError
aranya_afc_config_builder_set_address_ext(struct AranyaAfcConfigBuilder *cfg,
                                          const char *address,
                                          struct AranyaExtError *__ext_err);
#endif
...
#if defined(ENABLE_AFC)
/**
 * Attempts to construct an [`AranyaAfcConfig`](@ref AranyaAfcConfig), returning
 * an `Error::Bug` if there are invalid parameters.
 *
 * @param cfg a pointer to the afc config builder
 ...
 */
AranyaError
aranya_afc_config_builder_build_ext(struct AranyaAfcConfigBuilder *cfg,
                                    struct AranyaAfcConfig *out,
                                    struct AranyaExtError *__ext_err);
#endif
 ...
 */
AranyaError aranya_client_config_builder_set_daemon_addr(
 ...
 * @param address a string containing the address
 */
AranyaError aranya_client_config_builder_set_daemon_addr_ext(
    struct AranyaClientConfigBuilder *cfg, const char *address,
    struct AranyaExtError *__ext_err);
 ...
 *
 * @param cfg a pointer to the client config builder
 * @param afc_config a pointer to a valid AFC config (see
 * [`AranyaAfcConfigBuilder`](@ref AranyaAfcConfigBuilder))
 */
AranyaError aranya_client_config_builder_set_afc_config(
    struct AranyaClientConfigBuilder *cfg, struct AranyaAfcConfig *afc_config);
#endif
 ...
 * [`AranyaAfcConfigBuilder`](@ref AranyaAfcConfigBuilder))
 */
AranyaError aranya_client_config_builder_set_afc_config_ext(
    struct AranyaClientConfigBuilder *cfg, struct AranyaAfcConfig *afc_config,
    struct AranyaExtError *__ext_err);
#endif
 ...
 * returning an `Error::Bug` if there are invalid parameters.
 *
 * @param cfg a pointer to the client config builder
 * @param out a pointer to write the client config to
 */
AranyaError
aranya_client_config_builder_build(struct AranyaClientConfigBuilder *cfg,
 ...
 */
AranyaError
aranya_client_config_builder_build_ext(struct AranyaClientConfigBuilder *cfg,
                                       struct AranyaClientConfig *out,
                                       struct AranyaExtError *__ext_err);
 ...
 *
 * @param client the uninitialized Aranya Client [`AranyaClient`](@ref
 * AranyaClient).
 * @param config the client's configuration [`AranyaClientConfig`](@ref
 * AranyaClientConfig).
 *
 * @relates AranyaClient.
 */
 ...
 * @param __output the client's key bundle [`AranyaKeyBundle`](@ref
 * AranyaKeyBundle).
 *
 * @relates AranyaClient.
 */
 ...
 *
 * @param client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param __output the client's device ID [`AranyaDeviceId`](@ref
 * AranyaDeviceId).
 *
 * @relates AranyaClient.
 */
 ...
 * @param client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param addr the peer's Aranya network address [`AranyaAddr`](@ref
 * AranyaAddr).
 ...
 * @param client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param keys the device's public key bundle [`AranyaKeyBundle`](@ref
 * AranyaKeyBundle).
 *
 * @relates AranyaClient.
 */
 ...
 * @param team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param device the device's ID [`AranyaDeviceId`](@ref AranyaDeviceId).
 * @param role the role [`AranyaRole`](@ref AranyaRole) to revoke from the
 * device.
 *
 * @relates AranyaClient.
 */
 ...
 * @param client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param label the AFC channel label [`AranyaLabel`](@ref AranyaLabel) to
 * create.
 *
 * @relates AranyaClient.
 */
 ...
 * @param client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param device the device ID [`AranyaDeviceId`](@ref AranyaDeviceId) of the
 * device to assign the label to.
 ...
 * @param team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param device the device ID [`AranyaDeviceId`](@ref AranyaDeviceId) of the
 * device to revoke the label from.
 * @param label the AFC channel label [`AranyaLabel`](@ref AranyaLabel).
 *
 * @relates AranyaClient.
 */
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_afc_assign_net_identifier(
    struct AranyaClient *client, const struct AranyaTeamId *team,
    const struct AranyaDeviceId *device, AranyaNetIdentifier net_identifier);
#endif
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_afc_assign_net_identifier_ext(
    struct AranyaClient *client, const struct AranyaTeamId *team,
    const struct AranyaDeviceId *device, AranyaNetIdentifier net_identifier,
    struct AranyaExtError *__ext_err);
#endif
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_afc_remove_net_identifier(
    struct AranyaClient *client, const struct AranyaTeamId *team,
    const struct AranyaDeviceId *device, AranyaNetIdentifier net_identifier);
#endif
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_afc_remove_net_identifier_ext(
    struct AranyaClient *client, const struct AranyaTeamId *team,
    const struct AranyaDeviceId *device, AranyaNetIdentifier net_identifier,
    struct AranyaExtError *__ext_err);
#endif
 ...
 * @param client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param peer the peer's network identifier [`AranyaNetIdentifier`](@ref
 * AranyaNetIdentifier).
 * @param label the AFC channel label [`AranyaLabel`](@ref AranyaLabel) to
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_afc_create_bidi_channel_ext(
    struct AranyaClient *client, const struct AranyaTeamId *team,
    AranyaNetIdentifier peer, AranyaLabel label,
    struct AranyaChannelId *__output, struct AranyaExtError *__ext_err);
#endif
 ...
 *
 * @param client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param chan the AFC channel ID [`AranyaChannelId`](@ref AranyaChannelId) of
 ...
 * [`AranyaDuration`](@ref AranyaDuration).
 *
 * @relates AranyaClient.
 */
 ...
 * @param info information about the message [`AranyaAfcMsgInfo`](@ref
 * AranyaAfcMsgInfo).
 * @result A boolean indicating whether any data was available.
 *
 * @relates AranyaClient.
 */
AranyaError aranya_afc_recv_data(struct AranyaClient *client, uint8_t *buf,
                                 size_t *buf_len, struct AranyaAfcMsgInfo *info,
                                 bool *__output);
#endif
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_afc_recv_data_ext(struct AranyaClient *client, uint8_t *buf,
                                     size_t *buf_len,
 ...
 * When this field is set to true, syncing happens immediately after a peer is
 * added
 *
 * @param cfg a pointer to the builder for a sync config
 */
 ...
 * When this field is set to false, syncing occurs after some specifed duration
 * from when the peer is added
 *
 * @param cfg a pointer to the builder for a sync config
 */
 ...
 * @param cfg a pointer to the builder for a sync config
 */
AranyaError aranya_sync_peer_config_builder_build(
    const struct AranyaSyncPeerConfigBuilder *cfg,
 ...
 * @param cfg a pointer to the builder for a sync config
 */
AranyaError aranya_sync_peer_config_builder_build_ext(
    const struct AranyaSyncPeerConfigBuilder *cfg,
    struct AranyaSyncPeerConfig *out, struct AranyaExtError *__ext_err);
 ...
 * @param client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param devices returns a list of device IDs on the team
 * [`AranyaDeviceId`](@ref AranyaDeviceId).
 * @param devices_len returns the length of the devices list
 * [`AranyaDeviceId`](@ref AranyaDeviceId).
 *
 * @relates AranyaClient.
 */
 ...
 *
 * To always succeed, `str` must be at least `ARANYA_DEVICE_ID_STR_LEN` bytes
 * long.
 *
 ...
 * @relates AranyaError.
 */
AranyaError aranya_device_id_to_str(struct AranyaDeviceId device, char *str,
                                    size_t *str_len);
 ...
 * @param team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param device the device's ID [`AranyaDeviceId`](@ref AranyaDeviceId).
 * @param __output the device's key bundle [`AranyaKeyBundle`](@ref
 * AranyaKeyBundle).
 *
 * @relates AranyaClient.
 */
...
AranyaError aranya_query_device_keybundle_ext(
    struct AranyaClient *client, const struct AranyaTeamId *team,
    const struct AranyaDeviceId *device, struct AranyaKeyBundle *__output,
    struct AranyaExtError *__ext_err);
 ...
 * @param team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param device the device's ID [`AranyaDeviceId`](@ref AranyaDeviceId).
 * @param labels returns a list of labels assigned to the device
 * [`AranyaLabel`](@ref AranyaLabel).
 * @param labels_len returns the length of the labels list [`AranyaLabel`](@ref
 * AranyaLabel).
 *
 * @relates AranyaClient.
 */
AranyaError aranya_query_device_label_assignments(
    struct AranyaClient *client, const struct AranyaTeamId *team,
    const struct AranyaDeviceId *device, uint32_t *labels, size_t *labels_len);
 ...
 * @param team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param device the device's ID [`AranyaDeviceId`](@ref AranyaDeviceId).
 * @param network identifier string [`AranyaNetIdentifier`](@ref
 * AranyaNetIdentifier).
 *
 * @relates AranyaClient.
 */
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_query_afc_net_identifier_ext(
    struct AranyaClient *client, const struct AranyaTeamId *team,
 ...
 * @param team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param device the device's ID [`AranyaDeviceId`](@ref AranyaDeviceId).
 * @param __output the device's network identifier [`AranyaNetIdentifier`](@ref
 * AranyaNetIdentifier).
 *
 * @relates AranyaClient.
 */
AranyaError aranya_query_label_exists(struct AranyaClient *client,
                                      const struct AranyaTeamId *team,
                                      const AranyaLabel *label, bool *__output);
