 ...
 *
 * Output params:
 * @param perms returns a list of permissions [`AranyaRoleId`](@ref AranyaRoleId).
 * @param perms_len returns the length of the permissions list [`AranyaRoleId`](@ref AranyaRoleId).
 *
 * @relates AranyaClient.
 */
