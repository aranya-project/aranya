...
/**
 * An enum containing all [`AranyaAqcPeerChannel`](@ref AranyaAqcPeerChannel)
 * variants.
 */
...
/**
 * Configuration info builder for Aranya QUIC Channels config
 * [`AranyaAqcConfig`](@ref AranyaAqcConfig).
 *
 * This builder is unstable because [`AranyaAqcConfig`](@ref AranyaAqcConfig) is
 * unstable.
 */
 ...
 *
 * Use a [`AranyaAqcConfigBuilder`](@ref AranyaAqcConfigBuilder) to construct
 * this object.
 *
...
/**
 * A builder for initializing a [`AranyaQuicSyncConfig`](@ref
 * AranyaQuicSyncConfig).
 *
 * The [`AranyaQuicSyncConfig`](@ref AranyaQuicSyncConfig) is an optional part
 * of initializing a [`AranyaTeamConfig`](@ref AranyaTeamConfig).
 *
 * This builder is unstable because [`AranyaQuicSyncConfig`](@ref
 * AranyaQuicSyncConfig) is unstable.
 */
 ...
 *
 * Use a [`AranyaQuicSyncConfigBuilder`](@ref AranyaQuicSyncConfigBuilder) to
 * construct this object.
 *
 * This config is unstable.
 */
 ...
 * Team configuration.
 *
 * Use a [`AranyaTeamConfigBuilder`](@ref AranyaTeamConfigBuilder) to construct
 * this object.
 */
 ...
 *
 * @param[in] err the error to get a message for [`AranyaExtError`](@ref
 * AranyaExtError).
 ...
 *
 * @param[out] client the uninitialized Aranya Client [`AranyaClient`](@ref
 * AranyaClient).
 * @param[in] config the client's configuration [`AranyaClientConfig`](@ref
 * AranyaClientConfig).
 *
 ...
 *
 * @param[in] client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param[out] __output the client's device ID [`AranyaDeviceId`](@ref
 * AranyaDeviceId).
 *
 * @relates AranyaClient.
 */
 ...
 */
AranyaError
aranya_client_config_builder_init_ext(struct AranyaClientConfigBuilder *out,
                                      struct AranyaExtError *__ext_err);
 ...
 */
AranyaError
aranya_client_config_builder_cleanup_ext(struct AranyaClientConfigBuilder *ptr,
                                         struct AranyaExtError *__ext_err);
 ...
 */
AranyaError
aranya_aqc_config_builder_init_ext(struct AranyaAqcConfigBuilder *out,
                                   struct AranyaExtError *__ext_err);
 ...
 */
AranyaError
aranya_aqc_config_builder_cleanup(struct AranyaAqcConfigBuilder *ptr);
 ...
 */
AranyaError
aranya_aqc_config_builder_cleanup_ext(struct AranyaAqcConfigBuilder *ptr,
                                      struct AranyaExtError *__ext_err);
 ...
 */
AranyaError
aranya_aqc_config_builder_set_address(struct AranyaAqcConfigBuilder *cfg,
                                      const char *address);
 ...
 */
AranyaError
aranya_aqc_config_builder_set_address_ext(struct AranyaAqcConfigBuilder *cfg,
                                          const char *address,
                                          struct AranyaExtError *__ext_err);
 ...
 *
 * @param[in,out] cfg a pointer to the client config builder
 * @param[in] aqc_config a pointer to a valid AQC config (see
 * [`AranyaAqcConfigBuilder`](@ref AranyaAqcConfigBuilder))
 *
 * This method is unstable because [`AranyaAqcConfig`](@ref AranyaAqcConfig) is
 * unstable.
 *
 * @relates AranyaAqcConfigBuilder.
 */
AranyaError aranya_client_config_builder_set_aqc_config(
    struct AranyaClientConfigBuilder *cfg,
 ...
 * @relates AranyaAqcConfigBuilder.
 */
AranyaError aranya_client_config_builder_set_aqc_config_ext(
    struct AranyaClientConfigBuilder *cfg,
    const struct AranyaAqcConfig *aqc_config, struct AranyaExtError *__ext_err);
 ...
 */
AranyaError
aranya_quic_sync_config_builder_init(struct AranyaQuicSyncConfigBuilder *out);
 ...
 * @relates AranyaQuicSyncConfigBuilder
 */
AranyaError aranya_quic_sync_config_builder_init_ext(
    struct AranyaQuicSyncConfigBuilder *out, struct AranyaExtError *__ext_err);

/**
 * Releases any resources associated with `ptr`.
 *
 * `ptr` must either be null or initialized by
 * `::aranya_quic_sync_config_builder_init`.
 *
 * @relates AranyaQuicSyncConfigBuilder
 */
AranyaError aranya_quic_sync_config_builder_cleanup(
    struct AranyaQuicSyncConfigBuilder *ptr);
 ...
 * @relates AranyaQuicSyncConfigBuilder
 */
AranyaError aranya_quic_sync_config_builder_cleanup_ext(
    struct AranyaQuicSyncConfigBuilder *ptr, struct AranyaExtError *__ext_err);

/**
 * Attempts to set PSK seed generation mode value on
 * [`AranyaQuicSyncConfigBuilder`](@ref AranyaQuicSyncConfigBuilder).
 *
 ...
 */
AranyaError
aranya_quic_sync_config_generate(struct AranyaQuicSyncConfigBuilder *cfg);
 ...
 */
AranyaError
aranya_quic_sync_config_generate_ext(struct AranyaQuicSyncConfigBuilder *cfg,
                                     struct AranyaExtError *__ext_err);
 ...
 */
AranyaError
aranya_quic_sync_config_wrapped_seed(struct AranyaQuicSyncConfigBuilder *cfg,
 ...
 * @relates AranyaQuicSyncConfigBuilder.
 */
AranyaError aranya_quic_sync_config_wrapped_seed_ext(
    struct AranyaQuicSyncConfigBuilder *cfg, const uint8_t *encap_seed,
 ...
 * on [`AranyaQuicSyncConfigBuilder`](@ref AranyaQuicSyncConfigBuilder).
 *
 * @param[in,out] cfg a pointer to the quic sync config builder
 * [`AranyaQuicSyncConfigBuilder`](@ref AranyaQuicSyncConfigBuilder)
 * @param[in] ikm a pointer the raw PSK seed IKM [`AranyaSeedIkm`](@ref
 * AranyaSeedIkm)
 *
 * This method will be removed soon since certificates will be used instead of
 * PSKs in the future.
 ...
 */
AranyaError
aranya_quic_sync_config_raw_seed_ikm(struct AranyaQuicSyncConfigBuilder *cfg,
 ...
 * @relates AranyaQuicSyncConfigBuilder.
 */
AranyaError aranya_quic_sync_config_raw_seed_ikm_ext(
    struct AranyaQuicSyncConfigBuilder *cfg, const struct AranyaSeedIkm *ikm,
    struct AranyaExtError *__ext_err);
 ...
 * [`AranyaQuicSyncConfig`](@ref AranyaQuicSyncConfig)
 *
 * @relates AranyaQuicSyncConfigBuilder.
 */
AranyaError
aranya_quic_sync_config_build(struct AranyaQuicSyncConfigBuilder *cfg,
 ...
 */
AranyaError
aranya_quic_sync_config_build_ext(struct AranyaQuicSyncConfigBuilder *cfg,
                                  struct AranyaQuicSyncConfig *out,
                                  struct AranyaExtError *__ext_err);
 ...
 */
AranyaError
aranya_team_config_builder_init(struct AranyaTeamConfigBuilder *out);
 ...
 */
AranyaError
aranya_team_config_builder_init_ext(struct AranyaTeamConfigBuilder *out,
                                    struct AranyaExtError *__ext_err);
 ...
 *
 * `ptr` must either be null or initialized by
 * `::aranya_team_config_builder_init`.
 *
 * @relates AranyaTeamConfigBuilder
 */
AranyaError
aranya_team_config_builder_cleanup(struct AranyaTeamConfigBuilder *ptr);
 ...
 */
AranyaError
aranya_team_config_builder_cleanup_ext(struct AranyaTeamConfigBuilder *ptr,
                                       struct AranyaExtError *__ext_err);

/**
 * Configures QUIC syncer for [`AranyaTeamConfigBuilder`](@ref
 * AranyaTeamConfigBuilder).
 *
 * By default, the QUIC syncer config is not set. It is an error to call
 * [`aranya_team_config_build`](@ref aranya_team_config_build) before setting
 * the interval with this function
 *
 * @param[in,out] cfg a pointer to the builder for a team config
 * [`AranyaTeamConfigBuilder`](@ref AranyaTeamConfigBuilder)
 * @param[in] quic set the QUIC syncer config [`AranyaQuicSyncConfig`](@ref
 * AranyaQuicSyncConfig)
 *
 * @relates AranyaTeamConfigBuilder.
 */
AranyaError
aranya_team_config_builder_set_quic_syncer(struct AranyaTeamConfigBuilder *cfg,
 ...
 * @relates AranyaTeamConfigBuilder.
 */
AranyaError aranya_team_config_builder_set_quic_syncer_ext(
    struct AranyaTeamConfigBuilder *cfg, struct AranyaQuicSyncConfig *quic,
    struct AranyaExtError *__ext_err);
 ...
 * [`AranyaTeamConfig`](@ref AranyaTeamConfig)
 *
 * @relates AranyaTeamConfigBuilder.
 */
 ...
 * @relates AranyaSyncPeerConfigBuilder
 */
AranyaError aranya_sync_peer_config_builder_init_ext(
    struct AranyaSyncPeerConfigBuilder *out, struct AranyaExtError *__ext_err);
 ...
 * @relates AranyaSyncPeerConfigBuilder
 */
AranyaError aranya_sync_peer_config_builder_cleanup_ext(
    struct AranyaSyncPeerConfigBuilder *ptr, struct AranyaExtError *__ext_err);
 ...
 * [`AranyaSyncPeerConfigBuilder`](@ref AranyaSyncPeerConfigBuilder)
 * @param[out] out a pointer to write the sync config to
 * [`AranyaSyncPeerConfig`](@ref AranyaSyncPeerConfig)
 *
 * @relates AranyaSyncPeerConfigBuilder.
 */
AranyaError
 ...
 * @param[in] role the role [`AranyaRole`](@ref AranyaRole) to assign to the
 * device.
 *
 * @relates AranyaClient.
 */
 ...
 * @param[in] team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param[in] device the device's ID [`AranyaDeviceId`](@ref AranyaDeviceId).
 * @param[in] role the role [`AranyaRole`](@ref AranyaRole) to revoke from the
 * device.
 *
 * @relates AranyaClient.
 */
 ...
 * @param[in] client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param[in] team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param[in] label_id the channel label ID [`AranyaLabelId`](@ref
 * AranyaLabelId) to delete.
 *
 * @relates AranyaClient.
 */
 ...
 * @param[in] client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param[in] team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param[in] device the device ID [`AranyaDeviceId`](@ref AranyaDeviceId) of
 * the device to assign the label to.
 * @param[in] label_id the AQC channel label ID [`AranyaLabelId`](@ref
 * AranyaLabelId).
 *
 * @relates AranyaClient.
 */
 ...
 * @param[in] team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param[in] device the device ID [`AranyaDeviceId`](@ref AranyaDeviceId) of
 * the device to revoke the label from.
 * @param[in] label_id the AQC channel label ID [`AranyaLabelId`](@ref
 * AranyaLabelId).
 *
 * @relates AranyaClient.
 ...
 *
 * @param[in] client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param[in] cfg the Team Configuration [`AranyaTeamConfig`](@ref
 * AranyaTeamConfig).
 * @param[out] __output the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 *
 * This method is unstable because [`AranyaQuicSyncConfig`](@ref
 * AranyaQuicSyncConfig) is unstable.
 *
 * @relates AranyaClient.
 */
 ...
 */
AranyaError aranya_rand(struct AranyaClient *client, uint8_t *buf,
                        size_t buf_len);
 ...
 * @param[in] buf_len the size of the buffer.
 */
AranyaError aranya_rand_ext(struct AranyaClient *client, uint8_t *buf,
...
AranyaError aranya_encrypt_psk_seed_for_peer_ext(
    struct AranyaClient *client, const struct AranyaTeamId *team_id,
 ...
 * [`AranyaDeviceId`](@ref AranyaDeviceId).
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_query_device_keybundle_ext(
    struct AranyaClient *client, const struct AranyaTeamId *team,
 ...
 * [`AranyaLabelId`](@ref AranyaLabelId).
 * @param[in,out] labels_len returns the length of the labels list
 * [`AranyaLabelId`](@ref AranyaLabelId).
 *
 * @relates AranyaClient.
 */
AranyaError aranya_query_device_label_assignments(
    struct AranyaClient *client, const struct AranyaTeamId *team,
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_query_device_label_assignments_ext(
    struct AranyaClient *client, const struct AranyaTeamId *team,
    const struct AranyaDeviceId *device, struct AranyaLabelId *labels,
 ...
 * @param[in] client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param[in] team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param[out] labels returns a list of labels [`AranyaLabelId`](@ref
 * AranyaLabelId).
 * @param[in,out] labels_len returns the length of the labels list
 * [`AranyaLabelId`](@ref AranyaLabelId).
 *
 ...
 * @param[in] team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param[in] device the device's ID [`AranyaDeviceId`](@ref AranyaDeviceId).
 * @param[out] ident network identifier string [`AranyaNetIdentifier`](@ref
 * AranyaNetIdentifier).
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_query_aqc_net_identifier_ext(
    struct AranyaClient *client, const struct AranyaTeamId *team,
    const struct AranyaDeviceId *device, char *ident, size_t *ident_len,
    bool *__output, struct AranyaExtError *__ext_err);
 ...
 * @param[in] team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param[in] device the device's ID [`AranyaDeviceId`](@ref AranyaDeviceId).
 * @param[in] net_identifier the device's network identifier
 * [`AranyaNetIdentifier`](@ref AranyaNetIdentifier).
 *
 * @relates AranyaClient.
 */
AranyaError aranya_aqc_assign_net_identifier(
    struct AranyaClient *client, const struct AranyaTeamId *team,
    const struct AranyaDeviceId *device, AranyaNetIdentifier net_identifier);
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_aqc_assign_net_identifier_ext(
    struct AranyaClient *client, const struct AranyaTeamId *team,
    const struct AranyaDeviceId *device, AranyaNetIdentifier net_identifier,
    struct AranyaExtError *__ext_err);
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_aqc_remove_net_identifier(
    struct AranyaClient *client, const struct AranyaTeamId *team,
    const struct AranyaDeviceId *device, AranyaNetIdentifier net_identifier);
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_aqc_remove_net_identifier_ext(
    struct AranyaClient *client, const struct AranyaTeamId *team,
    const struct AranyaDeviceId *device, AranyaNetIdentifier net_identifier,
    struct AranyaExtError *__ext_err);
 ...
 */
AranyaError
aranya_aqc_peer_channel_cleanup_ext(struct AranyaAqcPeerChannel *ptr,
                                    struct AranyaExtError *__ext_err);
 ...
 */
AranyaError
aranya_aqc_bidi_channel_cleanup_ext(struct AranyaAqcBidiChannel *ptr,
                                    struct AranyaExtError *__ext_err);
 ...
 */
AranyaError
aranya_aqc_send_channel_cleanup_ext(struct AranyaAqcSendChannel *ptr,
                                    struct AranyaExtError *__ext_err);
 ...
 *
 * `ptr` must either be null or initialized by
 * `::aranya_aqc_receive_channel_init`.
 *
 * @relates AranyaAqcReceiveChannel
 */
AranyaError
aranya_aqc_receive_channel_cleanup(struct AranyaAqcReceiveChannel *ptr);
 ...
 */
AranyaError
aranya_aqc_receive_channel_cleanup_ext(struct AranyaAqcReceiveChannel *ptr,
                                       struct AranyaExtError *__ext_err);
 ...
 */
AranyaError
aranya_aqc_bidi_stream_cleanup_ext(struct AranyaAqcBidiStream *ptr,
                                   struct AranyaExtError *__ext_err);
 ...
 */
AranyaError
aranya_aqc_send_stream_cleanup_ext(struct AranyaAqcSendStream *ptr,
                                   struct AranyaExtError *__ext_err);
 ...
 *
 * `ptr` must either be null or initialized by
 * `::aranya_aqc_receive_stream_init`.
 *
 * @relates AranyaAqcReceiveStream
 */
AranyaError
aranya_aqc_receive_stream_cleanup(struct AranyaAqcReceiveStream *ptr);
 ...
 */
AranyaError
aranya_aqc_receive_stream_cleanup_ext(struct AranyaAqcReceiveStream *ptr,
                                      struct AranyaExtError *__ext_err);
 ...
 * @param[in]  client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param[in]  team the team's ID [`AranyaTeamId`](@ref AranyaTeamId).
 * @param[in]  peer the peer's network identifier [`AranyaNetIdentifier`](@ref
 * AranyaNetIdentifier).
 * @param[in]  label_id the AQC channel label ID [`AranyaLabelId`](@ref
 * AranyaLabelId) to create the channel with.
 * @param[out] channel the AQC channel object [`AranyaAqcBidiChannel`](@ref
 * AranyaAqcBidiChannel).
 *
 * @relates AranyaClient.
 */
AranyaError aranya_aqc_create_bidi_channel(
    struct AranyaClient *client, const struct AranyaTeamId *team,
    AranyaNetIdentifier peer, const struct AranyaLabelId *label_id,
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_aqc_create_bidi_channel_ext(
    struct AranyaClient *client, const struct AranyaTeamId *team,
    AranyaNetIdentifier peer, const struct AranyaLabelId *label_id,
    struct AranyaAqcBidiChannel *channel, struct AranyaExtError *__ext_err);
 ...
 * @param[in]  label_id the AQC channel label ID [`AranyaLabelId`](@ref
 * AranyaLabelId) to create the channel with.
 * @param[out] channel the AQC channel object [`AranyaAqcSendChannel`](@ref
 * AranyaAqcSendChannel).
 *
 * @relates AranyaClient.
 */
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_aqc_create_uni_channel_ext(
    struct AranyaClient *client, const struct AranyaTeamId *team,
    AranyaNetIdentifier peer, const struct AranyaLabelId *label_id,
    struct AranyaAqcSendChannel *channel, struct AranyaExtError *__ext_err);

/**
 * Delete a bidirectional AQC channel.
 *
 * Note that this function takes ownership of the [`AranyaAqcBidiChannel`](@ref
 * AranyaAqcBidiChannel) and invalidates any further use.
 *
 * @param[in] client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param[in] channel the AQC Channel [`AranyaAqcBidiChannel`](@ref
 * AranyaAqcBidiChannel) to delete.
 *
 * @relates AranyaClient.
 */
AranyaError
aranya_aqc_delete_bidi_channel(struct AranyaClient *client,
                               struct AranyaAqcBidiChannel *channel);
 ...
 */
AranyaError
aranya_aqc_delete_bidi_channel_ext(struct AranyaClient *client,
                                   struct AranyaAqcBidiChannel *channel,
                                   struct AranyaExtError *__ext_err);
 ...
 *
 * Note that this function takes ownership of the [`AranyaAqcSendChannel`](@ref
 * AranyaAqcSendChannel) and invalidates any further use.
 *
 * @param[in] client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param[in] channel the AQC Channel [`AranyaAqcSendChannel`](@ref
 * AranyaAqcSendChannel) to delete.
 *
 * @relates AranyaClient.
 */
 ...
 */
AranyaError
aranya_aqc_delete_uni_channel_ext(struct AranyaClient *client,
                                  struct AranyaAqcSendChannel *channel,
                                  struct AranyaExtError *__ext_err);
 ...
 *
 * Note that the [`AranyaAqcPeerChannel`](@ref AranyaAqcPeerChannel) must be
 ...
 *
 * @param[in]  client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param[out] channel the AQC channel holder [`AranyaAqcPeerChannel`](@ref
 * AranyaAqcPeerChannel).
 * @param[out] __output the corresponding AQC channel type
 * [`AranyaAqcChannelType`](@ref AranyaAqcChannelType).
 *
 * @relates AranyaClient.
 */
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_aqc_try_receive_channel_ext(
    struct AranyaClient *client, struct AranyaAqcPeerChannel *channel,
    AranyaAqcChannelType *__output, struct AranyaExtError *__ext_err);

/**
 * Converts the [`AranyaAqcPeerChannel`](@ref AranyaAqcPeerChannel)` into an
 * [`AranyaAqcBidiChannel`](@ref AranyaAqcBidiChannel) for sending/receiving
 * data.
 *
 * Returns `ARANYA_ERROR_INVALID_ARGUMENT` if called when the AqcPeerChannel is
 * the wrong type.
 *
 * Note that this function takes ownership of the [`AranyaAqcPeerChannel`](@ref
 * AranyaAqcPeerChannel) and invalidates any further use.
 *
 * @param[in]  channel the AQC channel holder [`AranyaAqcPeerChannel`](@ref
 * AranyaAqcPeerChannel) that holds a channel object.
 * @param[out] bidi the AQC channel object [`AranyaAqcBidiChannel`](@ref
 * AranyaAqcBidiChannel) that holds channel info.
 *
 * @relates AranyaClient.
 */
 ...
 */
AranyaError
aranya_aqc_get_bidi_channel_ext(struct AranyaAqcPeerChannel *channel,
                                struct AranyaAqcBidiChannel *bidi,
                                struct AranyaExtError *__ext_err);

/**
 * Converts the [`AranyaAqcPeerChannel`](@ref AranyaAqcPeerChannel)` into an
 * [`AranyaAqcReceiveChannel`](@ref AranyaAqcReceiveChannel) for receiving data.
 *
 * Returns `ARANYA_ERROR_INVALID_ARGUMENT` if called when the AqcPeerChannel is
 * the wrong type.
 *
 ...
 * AranyaAqcPeerChannel) and invalidates any further use.
 *
 * @param[in]  channel the AQC channel container [`AranyaAqcPeerChannel`](@ref
 * AranyaAqcPeerChannel).
 * @param[out] receiver the AQC channel object [`AranyaAqcReceiveChannel`](@ref
 * AranyaAqcReceiveChannel).
 *
 * @relates AranyaClient.
 */
AranyaError
aranya_aqc_get_receive_channel(struct AranyaAqcPeerChannel *channel,
 ...
 */
AranyaError
aranya_aqc_get_receive_channel_ext(struct AranyaAqcPeerChannel *channel,
                                   struct AranyaAqcReceiveChannel *receiver,
                                   struct AranyaExtError *__ext_err);

/**
 * Create a bidirectional stream from a [`AranyaAqcBidiChannel`](@ref
 * AranyaAqcBidiChannel).
 *
 ...
 *
 * @param[in]  client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param[in]  channel the AQC channel object [`AranyaAqcBidiChannel`](@ref
 * AranyaAqcBidiChannel).
 * @param[out] stream the bidirectional AQC stream [`AranyaAqcBidiStream`](@ref
 * AranyaAqcBidiStream).
 *
 * @relates AranyaClient.
 */
AranyaError
aranya_aqc_bidi_create_bidi_stream(struct AranyaClient *client,
                                   struct AranyaAqcBidiChannel *channel,
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_aqc_bidi_create_bidi_stream_ext(
    struct AranyaClient *client, struct AranyaAqcBidiChannel *channel,
    struct AranyaAqcBidiStream *stream, struct AranyaExtError *__ext_err);

/**
 * Send some data to a peer using an [`AranyaAqcBidiStream`](@ref
 * AranyaAqcBidiStream).
 *
 * @param[in] client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param[in] stream the sending side of a stream [`AranyaAqcBidiStream`](@ref
 * AranyaAqcBidiStream).
 ...
 *
 * @param[in]  stream the receiving side of a stream
 * [`AranyaAqcBidiStream`](@ref AranyaAqcBidiStream).
 ...
 */
AranyaError
aranya_aqc_bidi_stream_try_recv_ext(struct AranyaAqcBidiStream *stream,
                                    uint8_t *buffer, size_t *buffer_len,
                                    struct AranyaExtError *__ext_err);

/**
 * Create a unidirectional stream from an [`AranyaAqcBidiChannel`](@ref
 * AranyaAqcBidiChannel).
 *
 * Note that the recipient will not be able to receive the stream until data is
 * sent over the stream.
 ...
 * @param[in]  channel the AQC channel object [`AranyaAqcBidiChannel`](@ref
 * AranyaAqcBidiChannel).
 * @param[out] stream the sending side of a stream [`AranyaAqcSendStream`](@ref
 * AranyaAqcSendStream).
 *
 * @relates AranyaClient.
 */
AranyaError
aranya_aqc_bidi_create_uni_stream(struct AranyaClient *client,
                                  struct AranyaAqcBidiChannel *channel,
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_aqc_bidi_create_uni_stream_ext(
    struct AranyaClient *client, struct AranyaAqcBidiChannel *channel,
    struct AranyaAqcSendStream *stream, struct AranyaExtError *__ext_err);
 ...
 * sent over the stream.
 *
 * Additionally, the send stream will only be initialized if `send_init` is
 * true.
 *
 * @param[in]  channel the AQC channel object [`AranyaAqcBidiChannel`](@ref
 * AranyaAqcBidiChannel).
 * @param[out] recv_stream the receiving side of a stream
 * [`AranyaAqcReceiveStream`](@ref AranyaAqcReceiveStream).
 * @param[out] send_stream the sending side of a stream
 * [`AranyaAqcSendStream`](@ref AranyaAqcSendStream).
 * @param[out] send_init whether or not we received a `send_stream`.
 *
 * @relates AranyaClient.
 */
AranyaError
aranya_aqc_bidi_try_receive_stream(struct AranyaAqcBidiChannel *channel,
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_aqc_bidi_try_receive_stream_ext(
    struct AranyaAqcBidiChannel *channel,
    struct AranyaAqcReceiveStream *recv_stream,
    struct AranyaAqcSendStream *send_stream, bool *send_init,
    struct AranyaExtError *__ext_err);

/**
 * Create a unidirectional stream from an [`AranyaAqcSendChannel`](@ref
 * AranyaAqcSendChannel).
 *
 * Note that the recipient will not be able to receive the stream until data is
 * sent over the stream.
 *
 * @param[in]  client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param[in]  channel the AQC channel object [`AranyaAqcSendChannel`](@ref
 * AranyaAqcSendChannel).
 * @param[out] stream the sending side of a stream [`AranyaAqcSendStream`](@ref
 * AranyaAqcSendStream).
 *
 ...
 */
AranyaError
aranya_aqc_send_create_uni_stream(struct AranyaClient *client,
                                  struct AranyaAqcSendChannel *channel,
                                  struct AranyaAqcSendStream *stream);
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_aqc_send_create_uni_stream_ext(
    struct AranyaClient *client, struct AranyaAqcSendChannel *channel,
    struct AranyaAqcSendStream *stream, struct AranyaExtError *__ext_err);

/**
 * Receives the stream from an [`AranyaAqcReceiveChannel`](@ref
 * AranyaAqcReceiveChannel).
 *
 * Note that the recipient will not be able to receive the stream until data is
 * sent over the stream.
 ...
 * streams received yet which is considered a non-fatal error.
 *
 * @param[in]  channel the AQC channel object [`AranyaAqcReceiveChannel`](@ref
 * AranyaAqcReceiveChannel).
 * @param[out] stream the receiving side of a stream
 * [`AranyaAqcReceiveStream`](@ref AranyaAqcReceiveStream).
 *
 * @relates AranyaClient.
 */
AranyaError
aranya_aqc_recv_try_receive_uni_stream(struct AranyaAqcReceiveChannel *channel,
 ...
 * @relates AranyaClient.
 */
AranyaError aranya_aqc_recv_try_receive_uni_stream_ext(
    struct AranyaAqcReceiveChannel *channel,
    struct AranyaAqcReceiveStream *stream, struct AranyaExtError *__ext_err);

/**
 * Send some data over an [`AranyaAqcSendStream`](@ref AranyaAqcSendStream)m.
 *
 * @param[in] client the Aranya Client [`AranyaClient`](@ref AranyaClient).
 * @param[in] stream the sending side of a stream [`AranyaAqcSendStream`](@ref
 * AranyaAqcSendStream).
 * @param[in] data pointer to the data to send.
 * @param[in] data_len length of the data to send.
 *
...
/**
 * Receive some data from an [`AranyaAqcReceiveStream`](@ref
 * AranyaAqcReceiveStream).
 *
 * This can return `ARANYA_ERROR_WOULD_BLOCK` to signal that there aren't any
 * streams received yet which is considered a non-fatal error.
 ...
 */
AranyaError
aranya_aqc_recv_stream_try_recv(struct AranyaAqcReceiveStream *stream,
                                uint8_t *buffer, size_t *buffer_len);
 ...
 */
AranyaError
aranya_aqc_recv_stream_try_recv_ext(struct AranyaAqcReceiveStream *stream,
                                    uint8_t *buffer, size_t *buffer_len,
                                    struct AranyaExtError *__ext_err);
