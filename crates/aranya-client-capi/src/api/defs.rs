...
/// @param[in] team the team's ID
/// @param[in] role the ID of the subject role
/// @param[in] roles_out returns a list of roles that can assign `role`
/// @param[in,out] roles_len the number of roles written to the buffer.
///
/// @relates AranyaClient.
pub unsafe fn role_assigners(
    client: &Client,
    team: &TeamId,
    role: &RoleId,
    roles_out: *mut MaybeUninit<Role>,
    ...
    let roles = client
        .rt
        .block_on(client.inner.team(team.into()).role_assigners(role.into()))?
        .__into_data();
...
/// @param[in] team the team's ID
/// @param[in] role the ID of the subject role
/// @param[in] roles_out returns a list of roles that can revoke `role`
/// @param[in,out] roles_len the number of roles written to the buffer.
///
/// @relates AranyaClient.
pub unsafe fn role_revokers(
    client: &Client,
    team: &TeamId,
    role: &RoleId,
    roles_out: *mut MaybeUninit<Role>,
    ...
    let roles = client
        .rt
        .block_on(client.inner.team(team.into()).role_revokers(role.into()))?
        .__into_data();
...
/// @param[in] team the team's ID
/// @param[in] role the ID of the subject role
/// @param[in] roles_out returns a list of roles that can change `role` permissions
/// @param[in,out] roles_len the number of roles written to the buffer.
///
/// @relates AranyaClient.
pub unsafe fn role_permission_managers(
    client: &Client,
    team: &TeamId,
    role: &RoleId,
    roles_out: *mut MaybeUninit<Role>,
    ...
    let roles = client
        ...
        .block_on(
            client
                .inner
                .team(team.into())
                .role_permission_managers(role.into()),
        )?
        .__into_data();
