...
impl TestCtx {
    ...
    //= https://raw.githubusercontent.com/aranya-project/aranya-docs/refs/heads/main/docs/multi-daemon-convergence-test.md#conv-001
    ...
    #[instrument(skip(self), fields(source_node = %source_node))]
    pub async fn issue_test_command(&mut self, source_node: NodeIndex) -> Result<()> {
        ...
        //= https://raw.githubusercontent.com/aranya-project/aranya-docs/refs/heads/main/docs/multi-daemon-convergence-test.md#perf-001
    ...
    pub async fn wait_for_convergence(&mut self) -> Result<()> {
        ...
        loop {
            //= https://raw.githubusercontent.com/aranya-project/aranya-docs/refs/heads/main/docs/multi-daemon-convergence-test.md#conv-006
            ...
            //= https://raw.githubusercontent.com/aranya-project/aranya-docs/refs/heads/main/docs/multi-daemon-convergence-test.md#verify-002
    ...
    //= https://raw.githubusercontent.com/aranya-project/aranya-docs/refs/heads/main/docs/multi-daemon-convergence-test.md#verify-001
    ...
    async fn check_all_nodes_convergence(&mut self, team_id: TeamId) -> Result<()> {
        ...
        for i in 0..self.nodes.len() {
            ...
            if has_expected {
                //= https://raw.githubusercontent.com/aranya-project/aranya-docs/refs/heads/main/docs/multi-daemon-convergence-test.md#verify-004
                //# A node MUST be considered converged when it has received the convergence label.
                self.tracker.mark_converged(NodeIndex(i));
