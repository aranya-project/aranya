...
//     // Create a dummy channel for the PSK identity receiver needed by run_channels
//     let (_identity_tx, identity_rx) = mpsc::channel::<Vec<u8>>(1);
//     tokio::spawn(run_channels(server, sender, identity_rx));
//     Ok(server_addr)
// }
