...
#[doc(hidden)]
#[derive(Debug)]
pub struct PubAddTeamConfigBuilder {
    pub team_id: Option<TeamId>,
    pub quic_sync: Option<quic_sync::PubAddTeamQuicSyncConfigBuilder>,
}

#[doc(hidden)]
impl From<AddTeamConfigBuilder> for PubAddTeamConfigBuilder {
